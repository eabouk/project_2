...
## Anyone you worked with on this project: No one! 
...
## and if not, the function should access each page of the directory, get the HTML associated with it, append that HTML 
## string to a list. The function should cache (save) that list when it is accumulated.
...
def get_umsi_data():
	...
	for item in range(1, 12):
		...
		html_returns.append(unique_identifier)
		counter = counter + 1
...
## INPUT: Any string
## Behavior: See instructions. Should search for the input string on twitter and get results. Should check for cached data, 
